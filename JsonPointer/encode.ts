 ...
 * tildes.
 *
 * @example decodeToken("fo~100") // "fo/oo"
 *
 * @example decodeToken("7") // 7 (a number, not a string)
 */
 ...
 *
 * @example encodeToken("fo/00") // "fo~1oo"
 *
 * @example encodeToken(7) // "7" (a string)
 */
 ...
 *
 * @example parsePointer('/fo~1oo/7/ba~0rr') // ["fo/oo", 7, "ba~rr"]
 */
 ...
 *
 * @example decode('/fo~1oo/7/ba~0rr') // ["fo/oo", 7, "ba~rr"]
 */
 ...
 *
 * @example encode(["fo/oo", 7, "ba~rr"]) // '/fo~1oo/7/ba~0rr'
 */
