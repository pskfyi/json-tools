...
Deno.test("JsonTree", async ({ step: t }) => {
  ...
  await t("tree > entries()", () => equals(JsonTree.entries(TREE), ENTRIES));
  ...
  await t("iterables > childCrawler()", () => {});
  await t("iterables > leafCrawler()", () => {});
  await t("iterables > crawler()", () => {});
  await t("iterables > walker()", () => {});
  await t("iterables > childWalker()", () => {});

  await t("visitors > crawlChildren()", () => {
